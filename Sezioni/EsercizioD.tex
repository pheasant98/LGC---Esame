...
\begin{itemize}
	...
	Dall'applicazione della regola PAR-L posso dedurre che $\alpha_{1}$ $\in$ \tr{P|R}, |t'| = n  per ipotesi induttiva t' $\in$ \tr{P'|R}, allora t = $\alpha_{1}$t' $\in$ \tr{P|R}.  \\
	...
	Dall'applicazione della regola PAR-R posso dedurre che $\alpha_{1}$ $\in$ \tr{P|R}, |t'| = n per ipotesi induttiva t' $\in$ \tr{P|R'}, allora t = $\alpha_{1}$t' $\in$ \tr{P|R}.\\
	...
	Dall'applicazione della regola PAR-$\tau$ posso dedurre che $\tau_{1}$ $\in$ \tr{P|R}, |t'| = n per ipotesi induttiva t' $\in$ \tr{P'|R'}, allora t = $\tau_{1}$t' $\in$ \tr{P|R}.\\
...
Quindi dato che \tr{P\textbackslash L} = \tr{P}\textbackslash \{$\alpha_{1}$...$\alpha_{n}$|$\alpha_{i}\in$L\} con \tr{P} = \tr{Q}  allora si è dimostrato che  P\textbackslash L $\sim_{t}$ Q\textbackslash L.
