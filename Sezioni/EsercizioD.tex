...
Sia R un processo CCS, indichiamo con $\alpha$.\tr{R} l'insieme {$\alpha$t $\in$ \tr{R}}
...
Allora t = $\varepsilon \in $ \tr{$\alpha.P$}
\\
 
\textbf{Caso Induttivo |t| = n + 1}

t ha una prima interazione seguita poi dalla traccia t', cioè t = $\alpha_{1}$.t'.
Si ha quindi una transizione $\alpha.P \overset{\alpha_{1}}\rightarrow P$ dove per ipotesi induttiva t' $\in$ \tr{P}. Si sa che la sequenza di transizioni è permessa dalla regola del prefisso, quindi:

$\dfrac{}{\alpha.P \overset{\alpha_{1}}\rightarrow P\overset{t'}\rightarrow}$ \textit{ACT} \\

Questo dimostra che $\alpha.P$ sa fare l'interazione $\alpha_{1}$, perciò per ipotesi induttiva t'$\in$P allora $\alpha_{1}$.t' $\in$\tr{$\alpha$.P}.
\\
