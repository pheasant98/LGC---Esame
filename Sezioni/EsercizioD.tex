...
Si ha che \tr{C[P]} = \tr{$\alpha$.P} = $\alpha$.\tr{P}, dato che con il contesto C[ ] si è aggiunto l'interazione $\alpha$ alle \tr{P}. Per ipotesi \tr{P} = \tr{Q}, inoltre aggiungendo l'interazione $\alpha$ sia a \tr{P} e sia a \tr{Q}, si ha che $\alpha$.\tr{P} = $\alpha$.\tr{Q} = \tr{$\alpha$.Q}.
