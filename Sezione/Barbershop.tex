...
Attraverso la CWB con il commando mayeq(Sys1,SpecM) otteniamo la conferma che Tr(Sys1) = Tr(SpecM). Analogamente con mayeq(Sys2,SpecC) si dimostra che Tr(Sys2) = Tr(SpecC).
